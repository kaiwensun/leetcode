...
STARRED = {315, 321, 805, 913, 1199, 1713, 1819, 1923}
...
class Solution:
    ...
    def _calc_desired_folder(self):
        if self.is_us():
            ...
            folders = ["LCS", "LCP", "剑指 Offer", "面试题", "DD"]
...
def load_resources(client):
    ...
    def list_local_solutions():
        ...
        known_children_patterns = [
            "\d{4}-\d{4}", "LCS", "LCP", "剑指 Offer", "面试题", "DD", ".git", ".gitignore", "others", ".DS_Store", README_FILENAME]
