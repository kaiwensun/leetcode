...
* Last updat: Saturday, July 3, 2021
...
|:---|:---|:---|:---|:---|:---|
||5820|Minimum Time For K Viruses to Spread|[:us:](https://leetcode.com/problems/minimum-time-for-k-viruses-to-spread) [:cn:](https://leetcode-cn.com/problems/minimum-time-for-k-viruses-to-spread)||Hard|
||5819|Maximum of Minimum Values in All Subarrays|[:us:](https://leetcode.com/problems/maximum-of-minimum-values-in-all-subarrays) [:cn:](https://leetcode-cn.com/problems/maximum-of-minimum-values-in-all-subarrays)||Medium|
||5818|Longest Common Subsequence Between Sorted Arrays|[:us:](https://leetcode.com/problems/longest-common-subsequence-between-sorted-arrays) [:cn:](https://leetcode-cn.com/problems/longest-common-subsequence-between-sorted-arrays)||Medium|
||5817|Check If a String is Decomposble to Value-Equal Substrings|[:us:](https://leetcode.com/problems/check-if-a-string-is-decomposble-to-value-equal-substrings) [:cn:](https://leetcode-cn.com/problems/check-if-a-string-is-decomposble-to-value-equal-substrings)||Easy|
